...
class TestURLParser(unittest.TestCase):
    ...
    def test_simplest_url(self):
        u = URL('http://w4af.com/foo/bar.txt')
    ...
    def test_default_proto(self):
        ...
        """
        u = URL('w4af.com')
        self.assertEqual(u.get_domain(), 'w4af.com')
    ...
    def test_invalid_invalid_port(self):
        self.assertRaises(ValueError, URL, "http://w4af.com:998899")
    ...
    def test_decode_simple(self):
        qs_value = self.decode_get_qs('http://w4af.com/?id=1')
        expected = b'1'
        self.assertEqual(qs_value, expected)

    def test_decode_perc_20(self):
        qs_value = self.decode_get_qs('http://w4af.com/?id=1%202')
        expected = b'1 2'
        self.assertEqual(qs_value, expected)

    def test_decode_space(self):
        qs_value = self.decode_get_qs('http://w4af.com/?id=1 2')
        expected = b'1 2'
        self.assertEqual(qs_value, expected)
    ...
    def test_decode_url_encode_plus(self):
        ...
        qs_value = self.decode_get_qs('http://w4af.com/?id=1%2B2')
        expected = '1+2'
        self.assertEqual(qs_value, expected)
    ...
    def test_encode_simple(self):
        res_str = URL('http://w4af.com').url_encode()
        expected = 'http://w4af.com/'
        self.assertEqual(res_str, expected)

    def test_encode_perc_20(self):
        res_str = URL('https://w4af.com:443/file.asp?id=1%202').url_encode()
        expected = 'https://w4af.com/file.asp?id=1%202'
        self.assertEqual(res_str, expected)

    def test_encode_space(self):
        res_str = URL('https://w4af.com:443/file.asp?id=1 2').url_encode()
        expected = 'https://w4af.com/file.asp?id=1%202'
        self.assertEqual(res_str, expected)
    ...
    def test_encode_url_encode_plus(self):
        res_str = URL('https://w4af.com/file.asp?id=1%2B2').url_encode()
        EXPECTED = 'https://w4af.com/file.asp?id=1%2B2'
        self.assertEqual(res_str, EXPECTED)

    def test_encode_math(self):
        res_str = URL('http://w4af.com/x.py?ec=x*y/2==3').url_encode()
        EXPECTED = 'http://w4af.com/x.py?ec=x%2Ay%2F2%3D%3D3'
        self.assertEqual(res_str, EXPECTED)

    def test_encode_param(self):
        res_str = URL('http://w4af.com/x.py;id=1?y=3').url_encode()
        EXPECTED = 'http://w4af.com/x.py;id=1?y=3'
        self.assertEqual(res_str, EXPECTED)

    def test_decode_encode(self):
        """Encode and Decode should be able to run one on the result of the
        other and return the original"""
        original = URL('https://w4af.com:443/file.asp?id=1%202')
    ...
    def test_get_directories_path_levels_1(self):
        result = [i.url_string for i in URL('http://w4af.com/xyz/def/123/').get_directories()]
        expected = ['http://w4af.com/xyz/def/123/',
                    'http://w4af.com/xyz/def/',
                    'http://w4af.com/xyz/',
                    'http://w4af.com/']
        self.assertEqual(result, expected)
    
    def test_get_directories_path_levels_2(self):
        result = [i.url_string for i in URL('http://w4af.com/xyz/def/').get_directories()]
        expected = ['http://w4af.com/xyz/def/',
                    'http://w4af.com/xyz/',
                    'http://w4af.com/']
        self.assertEqual(result, expected)
    
    def test_get_directories_path_levels_3(self):
        result = [i.url_string for i in URL('http://w4af.com/xyz/').get_directories()]
        expected = ['http://w4af.com/xyz/', 'http://w4af.com/']
        self.assertEqual(result, expected)
    
    def test_get_directories_path_levels_4(self):
        result = [i.url_string for i in URL('http://w4af.com/').get_directories()]
        expected = ['http://w4af.com/']
        self.assertEqual(result, expected)

    def test_get_directories_filename(self):
        result = [i.url_string for i in URL('http://w4af.com/def.html').get_directories()]
        expected = ['http://w4af.com/']
        self.assertEqual(result, expected)
    ...
    def test_get_directories_fname_qs(self):
        ...
        result = [i.url_string for i in URL('http://w4af.com/def.html?id=5').get_directories()]
        self.assertEqual(result, expected)
        
        result = [i.url_string for i in URL('http://w4af.com/def.html?id=/').get_directories()]
        self.assertEqual(result, expected)
    ...
    def test_url_join_case01(self):
        u = URL('http://w4af.com/foo.bar')
        self.assertEqual(u.url_join('abc.html').url_string,
                         'http://w4af.com/abc.html')
    ...
    def test_url_join_case02(self):
        ...
        self.assertEqual(u.url_join('/def/abc.html').url_string,
                         'http://w4af.com/def/abc.html')

    def test_url_join_case03(self):
        u = URL('http://w4af.com/def/jkl/')
        self.assertEqual(u.url_join('/def/abc.html').url_string,
                         'http://w4af.com/def/abc.html')
        
        self.assertEqual(u.url_join('def/abc.html').url_string,
                         'http://w4af.com/def/jkl/def/abc.html')

    def test_url_join_case04(self):
        u = URL('http://w4af.com:8080/')
        self.assertEqual(u.url_join('abc.html').url_string,
                         'http://w4af.com:8080/abc.html')
    
    def test_url_join_case05(self):
        u = URL('http://w4af.com/def/')
        self.assertEqual(u.url_join('тест').url_string,
                         'http://w4af.com/def/тест')
    ...
    def test_base_url_path_fragment(self):
        u = URL('http://www.w4af.com/foo/bar.txt?id=3#foobar')
    ...
    def test_base_url_port(self):
        u = URL('http://www.w4af.com:80/')
        self.assertEqual(u.base_url().url_string,
                         'http://www.w4af.com/')

    def test_base_url_port_ssl(self):
        u = URL('https://www.w4af.com:443/')
        self.assertEqual(u.base_url().url_string,
                         'https://www.w4af.com/')

    def test_base_url_port_not_default(self):
        u = URL('http://www.w4af.com:8080/')
        self.assertEqual(u.base_url().url_string,
                         'http://www.w4af.com:8080/')

    def test_base_url_port_ssl_not_default(self):
        u = URL('https://www.w4af.com:8443/')
        self.assertEqual(u.base_url().url_string,
                         'https://www.w4af.com:8443/')
    ...
    def normalize_url_case05(self):
        u = URL('http://w4af.com/../f00.b4r?id=3&bar=4')
        u.normalize_url()
        self.assertEqual(u.url_string,
                         'http://w4af.com/f00.b4r?id=3&bar=4')

    def normalize_url_case06(self):
        u = URL('http://w4af.com/f00.b4r?id=3&bar=//')
        u.normalize_url()
        self.assertEqual(u.url_string,
                         'http://w4af.com/f00.b4r?id=3&bar=//')
    ...
    def normalize_url_case08_collapse_root(self):
        u = URL('http://w4af.com/../f00.b4r')
        u.normalize_url()
        self.assertEqual(u.url_string,
                         'http://w4af.com/f00.b4r')

    def normalize_url_case09_collapse_path(self):
        u = URL('http://w4af.com/abc/../f00.b4r')
        u.normalize_url()
        self.assertEqual(u.url_string,
                         'http://w4af.com/f00.b4r')

    def normalize_url_case10_collapse_double_slash(self):
        u = URL('http://w4af.com/a//b/f00.b4r')
        u.normalize_url()
        self.assertEqual(u.url_string,
                         'http://w4af.com/a/b/f00.b4r')
    ...
    def normalize_url_dotdot_in_qs(self):
        u = URL('http://w4af.com/f00.b4r?id=/../spam.py')
        u.normalize_url()
        self.assertEqual(u.url_string,
                         'http://w4af.com/f00.b4r?id=/../spam.py')
    ...
    def test_str_case01(self):
        self.assertEqual(str(URL('http://w4af.com/xyz.txt;id=1?file=2')),
                         'http://w4af.com/xyz.txt;id=1?file=2')
    
    def test_str_normalize_on_init(self):
        self.assertEqual(str(URL('http://w4af.com:80/')),
                         'http://w4af.com/')
    
    def test_str_special_encoding_filename(self):
        self.assertEqual(str(URL(b'http://w4af.com/ind\xe9x.html', 'latin1')),
                         'http://w4af.com/indéx.html')
    ...
    def test_str_special_encoding_query_string(self):
        ...
        self.assertEqual(str(url), 'http://w4af.com/a/b/é.php?x=á')
    ...
    def test_str_special_encoding_query_string_urlencoded(self):
        ...
        # url = URL('http://w4af.com/a/b/%E1%BA%BC.php?x=%E1%BA%BC')
    ...
    def test_unicode(self):
        ...
        self.assertEqual(str(URL('http://w4af.com/indéx.html', 'latin1')),
                         'http://w4af.com/ind%C3%A9x.html')

    @unittest.skip("Need a canonical encoding for URLs")
    def test_unicode_special_encoding_query_string(self):
        url = URL('http://w4af.com/a/b/é.php?x=á')
        self.assertEqual(str(url), 'http://w4af.com/a/b/%C3%A9.php?x=%C3%A1')

    #
    #    all_but_scheme
    #
    def test_all_but_scheme(self):
        self.assertEqual(URL('https://w4af.com:443/xyz/').all_but_scheme(),
                         'w4af.com/xyz/')
        
        self.assertEqual(URL('https://w4af.com:443/xyz/file.asp').all_but_scheme(),
                         'w4af.com/xyz/')
    ...
    def test_get_domain_path(self):
        self.assertEqual(URL('http://w4af.com/def/jkl/').get_domain_path().url_string,
                         'http://w4af.com/def/jkl/')
        
        self.assertEqual(URL('http://w4af.com/def.html').get_domain_path().url_string,
                         'http://w4af.com/')
        
        self.assertEqual(URL('http://w4af.com/xyz/def.html').get_domain_path().url_string,
                         'http://w4af.com/xyz/')
        
        self.assertEqual(URL('http://w4af.com:80/xyz/def.html').get_domain_path().url_string,
                         'http://w4af.com/xyz/')
        
        self.assertEqual(URL('http://w4af.com:443/xyz/def.html').get_domain_path().url_string,
                         'http://w4af.com:443/xyz/')
        
        self.assertEqual(URL('https://w4af.com:443/xyz/def.html').get_domain_path().url_string,
                         'https://w4af.com/xyz/')
        
        self.assertEqual(URL('http://w4af.com').get_domain_path().url_string,
                         'http://w4af.com/')
    ...
    def test_is_valid_domain_valid(self):
        ...
        self.assertTrue(URL('http://w4af.com').is_valid_domain())
        self.assertTrue(URL('http://w4af.com:39').is_valid_domain())
        self.assertTrue(URL('http://w4af.com:3932').is_valid_domain())
    ...
    def test_is_valid_domain_invalid(self):
        ...
        self.assertFalse(URL('http://-sub.w4af.com:39').is_valid_domain())
        self.assertFalse(URL('http://sub.-w4af.com:39').is_valid_domain())
    ...
    def test_get_path(self):
        self.assertEqual(URL('https://w4af.com:443/xyz/file.asp').get_path(),
                         '/xyz/file.asp')
        
        self.assertEqual(URL('https://w4af.com:443/xyz/file.asp?id=-2').get_path(),
                         '/xyz/file.asp')
        
        self.assertEqual(URL('https://w4af.com:443/xyz/').get_path(),
                         '/xyz/')
        
        self.assertEqual(URL('https://w4af.com:443/xyz/123/456/789/').get_path(),
                         '/xyz/123/456/789/')
        
        self.assertEqual(URL('https://w4af.com:443/').get_path(), '/')

    #
    #    get_params_string
    #
    def test_get_params_string(self):
        self.assertEqual(URL('http://w4af.com/').get_params_string(),
                         '')
        
        self.assertEqual(URL('http://w4af.com/;id=1').get_params_string(),
                         'id=1')
        
        self.assertEqual(URL('http://w4af.com/?id=3;id=1').get_params_string(),
                         '')
        
        self.assertEqual(URL('http://w4af.com/;id=1?id=3').get_params_string(),
                         'id=1')
        
        self.assertEqual(URL('http://w4af.com/foobar.html;id=1?id=3').get_params_string(),
                         'id=1')
    ...
    def test_get_params(self):
        self.assertEqual(URL('http://w4af.com/xyz.txt;id=1?file=2').get_params(),
                         {'id': '1'})
        
        self.assertEqual(URL('http://w4af.com/xyz.txt;id=1&file=2?file=2').get_params(),
                         {'id': '1', 'file': '2'})
        
        self.assertEqual(URL('http://w4af.com/xyz.txt;id=1&file=2?spam=2').get_params(),
                         {'id': '1', 'file': '2'})
                         
        self.assertEqual(URL('http://w4af.com/xyz.txt;id=1&file=2?spam=3').get_params(),
                         {'id': '1', 'file': '2'})
    ...
    def test_from_url(self):
        o = URL('http://w4af.com/foo/bar.txt')
        u = URL.from_URL(o)
    ...
    def test_url_string(self):
        u = URL('http://w4af.com/foo/bar.txt?id=1')
        self.assertEqual(u.url_string,
                         'http://w4af.com/foo/bar.txt?id=1')
        
        u = URL('http://w4af.com/foo%20bar/bar.txt?id=1')
        self.assertEqual(u.url_string,
                         'http://w4af.com/foo%20bar/bar.txt?id=1')

    def test_url_string_non_ascii(self):
        u = URL('http://w4af.com/foo/á.txt')
        self.assertEqual(u.url_string, 'http://w4af.com/foo/á.txt')

    def test_url_encode_non_ascii(self):
        u = URL('http://w4af.com/foo/á.txt')
        self.assertEqual(u.url_encode(), 'http://w4af.com/foo/%C3%A1.txt')
    ...
    def test_has_query_string(self):
        ...
        u = URL('http://w4af.com/foo/bar.txt;par=3')
        self.assertFalse(u.has_query_string())
    
    def test_get_query_string(self):
        self.assertEqual(URL('http://w4af.com/a/').querystring,
                         QueryString(list({}.items())))
        
        self.assertEqual(URL('http://w4af.com/foo/bar.txt?id=3').querystring,
                         QueryString(list({'id': ['3']}.items())))
        
        self.assertEqual(URL('http://w4af.com/foo/bar.txt?id=3&id=4').querystring,
                         QueryString(list({'id': ['3', '4']}.items())))
        
        url = URL('http://w4af.com/foo/bar.txt?id=3&ff=4&id=5')
        self.assertEqual(url.querystring,
                         QueryString(list({'id': ['3', '5'], 'ff': ['4']}.items())))
        
        self.assertEqual(url.querystring, parse_qs(str(url.querystring)))

    def test_uri2url(self):
        u = URL('http://w4af.com/foo/bar.txt?id=3')
        self.assertEqual(u.uri2url().url_string,
                         'http://w4af.com/foo/bar.txt')

    def test_remove_fragment(self):
        u = URL('http://w4af.com/foo/bar.txt?id=3#foobar')
        u.remove_fragment()
        self.assertEqual(u.url_string, 'http://w4af.com/foo/bar.txt?id=3')
        
        u = URL('http://w4af.com/foo/bar.txt#foobar')
        orig_qs_id = id(u.querystring)
        u.remove_fragment()
        self.assertEqual(u.url_string, 'http://w4af.com/foo/bar.txt')
        self.assertEqual(id(u.querystring), orig_qs_id)
    
    def test_get_port(self):
        self.assertEqual(URL('http://w4af.com/f00.b4r').get_port(), 80)
        self.assertEqual(URL('http://w4af.com:80/f00.b4r').get_port(), 80)
        
        self.assertEqual(URL('http://w4af.com:443/f00.b4r').get_port(), 443)
        self.assertEqual(URL('https://w4af.com/f00.b4r').get_port(), 443)
        self.assertEqual(URL('https://w4af.com:443/f00.b4r').get_port(), 443)
        self.assertEqual(URL('https://w4af.com:80/f00.b4r').get_port(), 80)

    def test_get_domain(self):
        self.assertEqual(URL('http://w4af.com/def/jkl/').get_domain(),
                         'w4af.com')
    ...
    def test_set_domain_with_port(self):
        u = URL('http://w4af.com:443/def/jkl/')
        self.assertEqual(u.get_domain(), 'w4af.com')
    ...
    def test_get_filename(self):
        self.assertEqual(URL('https://w4af.com:443/xyz/def.html').get_file_name(),
                         'def.html')
        self.assertEqual(URL('https://w4af.com:443/xyz/').get_file_name(), '')
        self.assertEqual(URL('https://w4af.com:443/xyz/d').get_file_name(), 'd')
    
    def test_set_filename(self):
        u = URL('https://w4af.com:443/xyz/def.html')
        u.set_file_name('abc.pdf')
        self.assertEqual(u.url_string,
                         'https://w4af.com/xyz/abc.pdf')
        self.assertEqual(u.get_file_name(), 'abc.pdf')

        u = URL('https://w4af.com/xyz/def.html?id=1')
        u.set_file_name('abc.pdf')
        self.assertEqual(u.url_string,
                         'https://w4af.com/xyz/abc.pdf?id=1')

        u = URL('https://w4af.com/xyz/def.html?file=/etc/passwd')
        u.set_file_name('abc.pdf')
        self.assertEqual(u.url_string,
                         'https://w4af.com/xyz/abc.pdf?file=%2Fetc%2Fpasswd')

        u = URL('https://w4af.com/')
        u.set_file_name('abc.pdf')
        self.assertEqual(u.url_string,
                         'https://w4af.com/abc.pdf')
    
    def test_get_extension(self):
        self.assertEqual(URL('https://w4af.com:443/xyz/d').get_extension(), '')
        self.assertEqual(URL('https://w4af.com:443/xyz/').get_extension(), '')
        self.assertEqual(URL('https://w4af.com:443/xyz/d.html').get_extension(),
                         'html')

    def test_set_extension(self):
        u = URL('https://www.w4af.com/xyz/foo')
        self.assertRaises(Exception, u.set_extension, 'xml')

        u = URL('https://w4af.com/xyz/d.html')
        u.set_extension('xml')
        self.assertEqual(u.get_extension(), 'xml')

        u = URL('https://w4af.com/xyz/d.html?id=3')
        u.set_extension('xml')
        self.assertEqual(u.get_extension(), 'xml')

        u = URL('https://w4af.com/xyz/d.html.foo?id=3')
        u.set_extension('xml')
        self.assertEqual(u.get_extension(), 'xml')
        self.assertEqual(u.url_string,
                         'https://w4af.com/xyz/d.html.xml?id=3')
    
    def test_get_path_without_filename(self):
        u = URL('https://w4af.com:443/xyz/file.asp')
        self.assertEqual(u.get_path_without_file(), '/xyz/')
        
        u = URL('https://w4af.com:443/xyz/')
        self.assertEqual(u.get_path_without_file(), '/xyz/')
        
        u = URL('https://w4af.com:443/xyz/123/456/789/')
    ...
    def test_get_path_qs_simple(self):
        ...
        u = URL('https://w4af.com:443/xyz/file.asp?id=1')
    ...
    def test_has_params(self):
        self.assertFalse(URL('http://w4af.com/').has_params())
        self.assertFalse(URL('http://w4af.com/?id=3;id=1').has_params())
        
        self.assertTrue(URL('http://w4af.com/;id=1').has_params())
        self.assertTrue(URL('http://w4af.com/;id=1?id=3').has_params())
        self.assertTrue(URL('http://w4af.com/foobar.html;id=1?id=3').has_params())

    def test_remove_params(self):
        self.assertEqual(URL('http://w4af.com/').remove_params().url_string,
                         'http://w4af.com/')
        self.assertEqual(URL('http://w4af.com/def.txt').remove_params().url_string,
                         'http://w4af.com/def.txt')
        self.assertEqual(URL('http://w4af.com/;id=1').remove_params().url_string,
                         'http://w4af.com/')
        self.assertEqual(URL('http://w4af.com/;id=1&file=2').remove_params().url_string,
                         'http://w4af.com/')
        self.assertEqual(URL('http://w4af.com/;id=1?file=2').remove_params().url_string,
                         'http://w4af.com/?file=2')
        self.assertEqual(URL('http://w4af.com/xyz.txt;id=1?file=2').remove_params().url_string,
                         'http://w4af.com/xyz.txt?file=2')

    def test_set_params(self):
        u = URL('http://w4af.com/;id=1')
        u.set_param('file=2')
        
        self.assertEqual(u.get_params_string(), 'file=2')
        
        u = URL('http://w4af.com/xyz.txt;id=1?file=2')
        u.set_param('file=3')
    ...
    def test_add(self):
        u = URL('http://www.w4af.com/')
        x = u + 'abc'
        self.assertEqual(x, 'http://www.w4af.com/abc')

        u = URL('http://www.w4af.com/')
        x = u + ' hello world!'
        self.assertEqual(x, 'http://www.w4af.com/ hello world!')
    ...
    def test_radd(self):
        u = URL('http://www.w4af.com/')
        x = 'abc' + u
        self.assertEqual(x, 'abchttp://www.w4af.com/')

        u = URL('http://www.w4af.com/')
        x = 'hello world! ' + u
        self.assertEqual(x, 'hello world! http://www.w4af.com/')

        u = URL('http://www.w4af.com/')
        self.assertRaises(TypeError, u.__radd__, 1)
    
    def test_nonzero(self):
        self.assertTrue( bool(URL('http://www.w4af.com')) )
    ...
    def test_copy(self):
        u = URL('http://www.w4af.com/?id=1&id=2')
