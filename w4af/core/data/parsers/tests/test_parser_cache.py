...
from w4af.core.data.parsers.parser_cache import ParserCache
from w4af.core.data.parsers.doc.url import URL
from w4af.core.data.url.HTTPResponse import HTTPResponse
from w4af.core.data.dc.headers import Headers
from w4af.core.data.parsers.tests.test_mp_document_parser import DelayedParser
...
class TestParserCache(unittest.TestCase):
    ...
    def test_bug_13_Dec_2012(self):
        url1 = URL('http://w4af.com/foo/')
        url2 = URL('http://w4af.com/bar/')
    ...
    def _is_timeout_exception_message(self, toe, http_resp):
        msg = 'Reached timeout parsing "http://w4af.com/".'
