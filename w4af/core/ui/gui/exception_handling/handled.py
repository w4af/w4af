...
"""
from w4af.core.controllers.exception_handling.helpers import gettempdir, create_crash_file
from w4af.core.ui.gui.exception_handling import handled_bug_report


def handle_exceptions(w4af_core):
    """
    In w4af's new exception handling method, some exceptions raising from
    ...
    for edata in w4af_core.exception_handler.get_unique_exceptions():
    ...
    print(w4af_core.exception_handler.generate_summary_str())
    ...
    bug_report_win = handled_bug_report.BugReportWindow(w4af_core, title)
