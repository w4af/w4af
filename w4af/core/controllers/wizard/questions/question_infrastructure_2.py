...
class question_infrastructure_2(question):
    ...
    def __init__(self, w4af_core):
        ...
        self._question_str += ' w4af and the target Web Application.'
    ...
    def get_next_question_id(self, options_list):
        ...
        old_discovery = self.w4af_core.plugins.get_enabled_plugins('infrastructure')
        plugin_list.extend(old_discovery)
        self.w4af_core.plugins.set_plugins(plugin_list, 'infrastructure')
