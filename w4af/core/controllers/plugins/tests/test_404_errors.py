...
from w4af.plugins.grep.meta_tags import meta_tags
...
class Test404Errors(unittest.TestCase):
    ...
    def test_handles_404_exception(self):
        ...
        with patch('w4af.plugins.grep.meta_tags.is_404') as is_404_mock,\
        patch('w4af.core.controllers.plugins.grep_plugin.om.out') as om_mock:
