...
from w4af.core.controllers.core_helpers.not_found.get_clean_body import get_clean_body
from w4af.core.controllers.core_helpers.fingerprint_404 import IS_EQUAL_RATIO
...
class Test404FuzzyStringMatch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not os.path.exists(shelve_file):
            pytest.skip('No shelve, get it from w4af-misc repository.')
