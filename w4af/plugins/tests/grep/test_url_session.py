...
from w4af.plugins.grep.url_session import url_session
...
class TestURLInSession(unittest.TestCase):
    ...
    def test_url_session_in_url(self):
        body = 'abc'
        url = URL('http://www.w4af.com/?JSESSIONID=231badb19b93e44f47da1bd64a8147f2')
        headers = Headers([('content-type', 'text/html')])
        request = FuzzableRequest(url, method='GET')
        resp = HTTPResponse(200, body, headers, url, url, _id=1)
    ...
    def test_url_session_in_body(self):
        url = 'http://www.w4af.com/?JSESSIONID=231badb19b93e44f47da1bd64a8147f2'
