...
from w4af.core.controllers.ci.sqlmap_testenv import get_sqlmap_testenv_http
from w4af.core.controllers.ci.moth import get_moth_http

from w4af.plugins.tests.helper import PluginConfig, ReadExploitTest
from w4af.core.data.kb.vuln_templates.sql_injection_template import SQLiTemplate
...
class TestSQLMapShell(ReadExploitTest):
    ...
    def test_found_exploit_blind_sqli_form_GET(self):
        ...
        #   Execute the exploit.
        #
        plugin = self.w4afcore.plugins.get_plugin_inst('attack', 'sqlmap')
