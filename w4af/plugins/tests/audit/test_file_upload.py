...
from w4af.core.controllers.ci.php_moth import get_php_moth_http as moth
...
class TestParseOutputFromUpload(PluginTest):
    ...
    def test_parse_response(self):
        ...
        with patch('w4af.plugins.audit.file_upload.rand_alnum') as rand_alnum_mock:
...
class TestRegexOutputFromUpload(TestParseOutputFromUpload):
    ...
    FILE_CONTENT_RAND = 'w4af.core.data.fuzzer.utils.rand_alnum'
    IMAGE_CONTENT = 'PNG' + 'B' * 239

    FILENAME_RAND_ALPHA = 'w4af.core.data.constants.file_templates.file_templates.rand_alpha'
