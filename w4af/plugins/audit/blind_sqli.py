...
from w4af.core.controllers.sql_tools.blind_sqli_response_diff import BlindSqliResponseDiff
from w4af.core.controllers.sql_tools.blind_sqli_time_delay import BlindSQLTimeDelay
