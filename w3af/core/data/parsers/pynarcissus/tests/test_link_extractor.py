...
from w4af.core.data.parsers.utils.url_regex import URL_RE
from w4af.core.data.parsers.doc.url import URL
from w4af.core.data.parsers.pynarcissus.link_extractor import JSLinkExtractor
from w4af.core.data.parsers.pynarcissus.tests.test_string_extractor import JSParserMixin
