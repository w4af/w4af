...
from w4af.core.data.constants.browsers import INTERNET_EXPLORER_7
from w4af.core.data.constants.dbms import MYSQL
from w4af.core.data.constants.disclaimer import DISCLAIMER
from w4af.core.data.constants.ports import MAILER
from w4af.core.data.constants.response_codes import OK
from w4af.core.data.constants.severity import HIGH
from w4af.core.data.constants.ignored_params import IGNORED_PARAMETERS
