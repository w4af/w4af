...
from w4af.core.data.context.tests.context_test import ContextTest
from w4af.core.data.context.context import get_context
from w4af.core.data.context.context.html import (HtmlTag,
                                                 CSSText,
                                                 HtmlAttr,
                                                 HtmlText,
                                                 ScriptText,
...
class TestHTMLContext(ContextTest):
    ...
    def test_django_500_sample(self):
        with open(os.path.join(self.SAMPLES_DIR, 'django-500.html')) as f:
            html = f.read()
