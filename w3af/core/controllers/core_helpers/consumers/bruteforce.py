...
class bruteforce(BaseConsumer):
    ...
    def __init__(self, bruteforce_plugins, w4af_core):
        """
        ...
        """
        super(bruteforce, self).__init__(bruteforce_plugins, w4af_core,
    ...
    def _bruteforce(self, function_id, plugin, fuzzable_request):
        ...
        # Status
        self._w4af_core.status.set_running_plugin('bruteforce', plugin.get_name())
        self._w4af_core.status.set_current_fuzzable_request('bruteforce',
                                                            fuzzable_request)
