...
class TestEvasion(unittest.TestCase):
    ...
    def test_add_path_to_base_url(self):
        ...
        self.assertRegex(url_string, r'http://www.w3af.com/\w*/../')
    ...
    def test_add_path_to_path_url(self):
        ...
        self.assertRegex(url_string, r'http://www.w3af.com/\w*/../abc/')
    ...
    def test_add_with_filename(self):
        ...
        self.assertRegex(url_string, r'http://www.w3af.com/\w*/../abc/def.htm')
    ...
    def test_add_with_qs(self):
        ...
        self.assertRegex(url_string, r'http://www.w3af.com/\w*/../abc/def.htm\?id=1')
