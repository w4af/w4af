...
from w4af.plugins.evasion.reversed_slashes import reversed_slashes
...
class TestEvasion(unittest.TestCase):
    ...
    def test_path_file(self):
        ...
        r = HTTPRequest( u )
        self.assertEqual(rs.modify_request( r ).url_object.url_string,
                         'http://www.w4af.com/abc\\def.htm')

    def test_long_path_file(self):
        rs = reversed_slashes()
        
        u = URL('http://www.w4af.com/abc/123/def.htm')
        r = HTTPRequest( u )
        self.assertEqual(rs.modify_request( r ).url_object.url_string,
                         'http://www.w4af.com/abc\\123\\def.htm')
        #
