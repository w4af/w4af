...
.. warning::
   ...
   Currently it is not possible to install w3af on kali as pygtk is not any more in the kali packages, see `here <https://pkg.kali.org/pkg/pygtk>`_. So the following instructions currently won't work. You could try building pygtk from source though. 
